...
var (
	...
	grpcRacingEndpoint = flag.String("grpc-racing-endpoint", "localhost:9000", "Racing gRPC server endpoint")
	grpcSportsEndpoint = flag.String("grpc-sports-endpoint", "localhost:9100", "Sports gRPC server endpoint")
)
